...
const Footer: React.FC = () => (
  <footer className="text-white body-font bg-[#210a3e]">
    {' '}
    ...
    <div className="container px-5 mx-auto flex flex-wrap justify-center items-start">
      ...
      <div className="lg:w-1/5 md:w-1/4 w-full px-4 mb-4 ">
        ...
        <nav className="list-none mb-10 space-y-4 text-sm ">
          ...
          <li>
            <a href="https://fablab.uv.cl/" className="text-white">
              Sobre el FabLab UV
            </a>
          </li>{' '}
          {/* Enlace con href */}
          <li>
            <a href="https://ingenieria.uv.cl/" className="text-white">
      ...
      <div className="lg:w-1/5 md:w-1/4 w-full px-4 mb-4">
        ...
        <nav className="list-none mb-10 space-y-4 text-sm ">
          <li>
            <a href="https://instagram.com/fablabuv" className="text-white">
              Instagram
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="https://facebook.com/fablabuv" className="text-white">
              Facebook
            </a>
          </li>{' '}
          {/* Agregamos Facebook */}
      ...
      <div className="lg:w-1/5 md:w-1/4 w-full px-4 mb-4">
        ...
        <nav className="list-none mb-10 space-y-4 text-sm ">
          <li>
            <a href="https://www.fundacionfuturo.cl/" className="text-white">
              Fundación Futuro
            </a>
          </li>
          <li>
            <a href="https://www.positronica.cl/" className="text-white">
              Positrónica
            </a>
          </li>
          <li>
      ...
      <div className="lg:w-1/5 md:w-1/4 w-full px-4 mb-4">
        ...
        <nav className="list-none mb-10 space-y-4 text-sm ">
          <li>
            <a href="https://eiva.cl/" className="text-white">
              EIVA
            </a>
          </li>
          <li>
            <a href="https://v21.cl/" className="text-white">
    ...
    <div className="bg-[#06717e]">
      <div className="container mx-auto py-0.5 px-5 flex flex-wrap flex-col sm:flex-row justify-between items-center">
